...
public class PrefixTree {
    ...
    public static void main(String[] params) throws IOException {
        ...
        List<String> lines = Files.readAllLines(Paths.get(".\\src\\com\\aads\\prefixTree\\test\\numbers.txt"));
...
//        System.out.println(root.containString("18АА0603"));
        ...
        writeTreeToFile(".\\src\\com\\aads\\prefixTree\\test\\tree.dat", root);

        TreeNode fromFile = readFromFile(".\\src\\com\\aads\\prefixTree\\test\\tree.dat");
