...
public class TestMain {
    ...
    private static void fileCodecTest() {
        try {
            ...
            BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(new FileOutputStream(".\\src\\com\\aads\\huffmanAdapt\\test\\About coffee.txt"));
            ...
            BufferedOutputStream decodeOutput = new BufferedOutputStream(new FileOutputStream(".\\src\\com\\aads\\huffmanAdapt\\test\\decoded.txt"));
            HuffmanDecoderStream huffmanDecoderStream = new HuffmanDecoderStream(new EncodingModelRefreshing(), decodeOutput);
            BufferedInputStream inputStream = new BufferedInputStream(new FileInputStream(".\\src\\com\\aads\\huffmanAdapt\\test\\About coffee.txt-1.huf"));
    ...
    private static void fileCodecDigitalTest() {
        try {
            BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(new FileOutputStream(".\\src\\com\\aads\\huffmanAdapt\\test\\About coffee.txt-1.huf"));
            HuffmanEncoderStream huffmanEncoderStream = new HuffmanEncoderStream(new EncodingModelRefreshing(), bufferedOutputStream);

            BufferedInputStream bis = new BufferedInputStream(new FileInputStream(".\\src\\com\\aads\\huffmanAdapt\\test\\About coffee.txt"));
